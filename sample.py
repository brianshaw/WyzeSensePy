...
def playSounds(start_event, stop_event, exit_event):
    ...
    while not exit_event.is_set():
        ...
        if start_event.wait(1) and start_event.is_set() and not stop_event.is_set():
            ...
            asyncio.run(Sound.play_random_sounds(soundclips, soundtime, f'mpg123 -g {volume} -o alsa --aggressive', resetSoundAndLed))
            # asyncio.run(Sound.play_random_sounds(soundclips, soundtime, f'mpg321 -g {volume} -o alsa --aggressive', resetSoundAndLed))
